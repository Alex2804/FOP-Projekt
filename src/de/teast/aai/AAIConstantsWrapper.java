...
public class AAIConstantsWrapper {
    private static int valueCount = 32;

    public AAIConstantsWrapper(){
        super();
    }
    public AAIConstantsWrapper(double[] values){
        super();
        load(values);
    }
    public AAIConstantsWrapper(boolean randomValues){
        super();
        if(randomValues)
            generateRandom();
    }
    public AAIConstantsWrapper(String filename){
        super();
        try {
            read(filename);
        } catch (IOException e) {
